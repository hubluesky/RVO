...
export class RVOMath {
  ...
  public static distSqPointLineSegment(vector1: Vector2, vector2: Vector2, vector3: Vector2) {
    let r = Vector2.dot(
      Vector2.subtract(vector3, vector1),
      Vector2.subtract(vector2, vector1)
    ...
    return this.absSq(Vector2.subtract(vector3, Vector2.add(vector1, Vector2.multiply(Vector2.subtract(vector2, vector1), r))));
  }
